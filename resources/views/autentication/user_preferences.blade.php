...
<div class="min-h-screen w-full flex items-stretch bg-blue-100">
    <div style="width: 500px; flex-shrink: 0;">
        <img style="object-fit: cover; height: 100vh; width: 500px;" src="https://images.unsplash.com/photo-1464746133101-a2c3f88e0dd9?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1327&q=80">
    </div>
        ...
        <form class="mt-8 space-y-6" method="POST" action="{{route('user-preferences.store')}}"  id="form-stepper">
            ...
            <div class="step step-1">
                <div class="rounded-md shadow-sm -space-y-px mb-10">
                    <div class="mb-10">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="has_allergies">¿Cuentas con alergias?</label>
                        <input type="checkbox" name="has_allergies" id="has_allergies" class="form-checkbox h-5 w-5 text-blue-600">
                    </div>
                    <div class="mb-10">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="allergy_type">¿Qué tipo de alergia?</label>
            ...
            <div class="step step-2 hidden">
                <div class="rounded-md shadow-sm -space-y-px mb-10">
                    <div class="mb-10">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="diet_type">¿Qué tipo de alimentación consumes?</label>
                        <div class="flex space-x-4">
                            <button type="button" class="option flex flex-col items-center border p-2 rounded hover:bg-gray-200 cursor-pointer" data-value="vegan">
                                <img class="w-32 h-32" src="{{ asset('images/vegana.jpg') }}" alt="Vegan">
                                <span class="mt-2 text-center">Vegana</span>
                            </button>
                            <button type="button" class="option flex flex-col items-center border p-2 rounded hover:bg-gray-200 cursor-pointer" data-value="vegetarian">
                                <img class="w-32 h-32" src="{{ asset('images/vegetariana.jpg') }}" alt="Vegetarian">
                                <span class="mt-2 text-center">Vegetariana</span>
                            </button>
                            <button type="button" class="option flex flex-col items-center border p-2 rounded hover:bg-gray-200 cursor-pointer" data-value="carnivore">
