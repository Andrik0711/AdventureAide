        ...
        <div id="gallery" class="relative w-full" data-carousel="slide">
            ...
            <div class="relative h-96 overflow-hidden rounded-lg md:h-[400px]">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('images/1.png') }}" class="absolute block w-full h-[400px] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
                </div>
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                    <img src="{{ asset('images/2.png') }}" class="absolute block w-full h-[400px] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="{{ asset('images/3.png') }}" class="absolute block w-full h-[400px] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="">
                </div>
...
<section class=" container pt-48  bg-white flex flex-col justify-center">
  <div class="grid grid-cols-2 gap-10 max-w-6xl mx-auto">
    <div class="-mt-20 flex justify-end">
      <img class="w-2/3 h-2/3 object-cover rounded-lg overflow-hidden" src="https://s-media-cache-ak0.pinimg.com/736x/5f/ed/16/5fed16fd7c9c2d40bb7176c6fe328e0d.jpg" />
    </div>
    <div class="flex justify-start">
      <img class="rounded-lg object-cover overflow-hidden" src="https://i.pinimg.com/originals/47/82/4d/47824dc2320724a79e56be69edcc73bf.jpg" />
    </div>
    ...
    <div class="-translate-y-96 transform ml-28 -mr-28 p-16 shadow-xl rounded-xl overflow-hidden bg-white">
      <div class="space-y-4">
        <p class="text-5xl font-bold text-black tracking-tight">
          AdventureAide es una emocionante aplicación diseñada para los amantes de la aventura y los viajes.
        </p>
        <p class="text-xl text-black"> 
          Nuestra plataforma revolucionaria ofrece una experiencia personalizada al ayudarte a planificar tus 
          viajes de ensueño según tus preferencias individuales.

          Con AdventureAide, puedes explorar una amplia gama de destinos emocionantes y actividades al aire libre
          en todo el mundo. Ya sea que busques la adrenalina de practicar deportes extremos, la serenidad de 
          sumergirte en la naturaleza o la emoción de descubrir nuevas culturas, nuestra aplicación está aquí 
